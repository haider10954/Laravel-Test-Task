...
(function (h) {
  ...
  t("rows().indexes()", "row().index.blade.php()", function () {
    return this.iterator(
      "row",
      function (a, b) {
        return b;
  ...
  t("columns().indexes()", "column().index.blade.php()", function (a) {
    return this.iterator(
      "column",
      function (b, c) {
  ...
  o("column.index.blade.php()", function (a, b) {
  ...
  t("cells().indexes()", "cell().index.blade.php()", function () {
    return this.iterator(
      "cell",
      function (a, b, c) {
